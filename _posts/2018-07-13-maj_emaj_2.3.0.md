...
Il est maintenant possible d'ajouter des tables et séquences dans un groupe de tables actif ou de déplacer une table ou une séquence d'un groupe de tables à un autre, l'un des deux ou les deux étant actifs.
...
**Liens importants : **
 * il est possible de procéder à la mise à jour de la version, groupes actifs,

...
La communauté PostgreSQL propose désormais un dépot de paquets RPM pour la
distribution SUSE SLES 12 sur <https://zypp.postgresql.org/>.

Ce nouveau dépot contient des paquets pour les versions 9.5, 9.6 et 10 de
...
déja dans le dépot YUM : les versions 10, 9.6 et 9.5 sont supportés ainsi qu'une 
...
Pour utiliser ce dépot SLES, vous pouvez vous reporter à un 
[How To détaillé](https://zypp.postgresql.org/howtozypp.php) .

Ces nouveaux paquets et ce dépot SLES sont maintenu par 

...
Une série de conférences, données par des experts internationaux en français et en anglais, vous permettra de faire le tour des thèmes en enjeux actuels, tout en étant retransmise en direct sur notre [chaîne Youtube](https://dali.bo/dalibo_youtube). Vous souhaitez proposer une conférence ? Le Call for Papers sera en ligne dès la rentrée.

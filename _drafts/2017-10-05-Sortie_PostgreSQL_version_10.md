...
Evidemment que non, le projet a encore de nombreuses [pistes d'améliorations](https://wiki.postgresql.org/wiki/Todo) et [un certain nombre](https://wiki.postgresql.org/wiki/PostgreSQL11_Roadmap) d'entre elles seront dans la future version 11 qui sortira dans 12 mois.

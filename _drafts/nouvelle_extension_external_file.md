...
Cette nouvelle extension permet l'accès sécurisé à des fichiers externes à
PostgreSQL depuis la base de données. Si vous connaissez les BFILES sous
Oracle, cela vous dira certainement quelque chose. Le but de cette extension
est de pouvoir manipuler des fichiers à l'extérieur du système de base de
données PostgreSQL.
